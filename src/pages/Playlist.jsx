    ...
    return (
      <>
       ...
       hidden lg:block arrow-btn "
            ...
            <div
              ref={scrollRef}
              className=" grid lg:grid-rows-2 lg:grid-cols-none scroll-smooth grid-cols-2  lg:grid-flow-col-dense gap-[1rem] w-full px-[2rem] overflow-x-scroll scroll-hide">
              {playlists.map((genre) => (
